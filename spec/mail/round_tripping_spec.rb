...
describe "Round Tripping" do
  ...
  it "should round trip a basic email with trailing whitespaces", :focus => true do
    mail = Mail.new('Subject: FooBar')
    mail.body "This is Text\n   \n"
    parsed_mail = Mail.new(mail.to_s)
    parsed_mail.subject.to_s.should eq "FooBar"
    parsed_mail.body.to_s.should eq "This is Text\n   \n"
    parsed_mail.encoded.should eq(mail.encoded)
  end
  ...
  it "should round trip a html multipart email with trailing whitespaces", :focus => true do
    mail = Mail.new('Subject: FooBar')
    mail.text_part = Mail::Part.new do
      body "This is Text\n   \n"
    end
